# -*- coding: utf-8 -*-
#
# cookiecutter_pywf_internal_proprietary_demo documentation build configuration file, created by
...
import cookiecutter_pywf_internal_proprietary_demo as package
...
# Add data for Jinja2
try:
    from cookiecutter_pywf_internal_proprietary_demo.docs import doc_data
except:
    doc_data = dict()
